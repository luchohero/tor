...
urlpatterns = patterns('',
    ...
    url(r'^reporte_boleto/$', 'app.views.Reporte_Boleto',),
    url(r'^reporte_funcionario/$', 'app.views.Reporte_Funcionario',),
    url(r'^salir/$', 'app.views.Salir',),
    url(r'^excel/$', 'app.views.xls',),
    url(r'^entrega-socio/$', 'app.views.EntregaSocio',),
    url(r'^entrega-socio/(\d+)/(\d+)/$', 'app.views.EntregaSocio1',),
    ...
    url(r'^entrega-boletos/(\d+)/(\d+)/(\d+)/$', 'app.views.EntregaBoletos1'),
